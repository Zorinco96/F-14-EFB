...
def run_validation_battery(
    ...
    """Run the maintained operational scenario matrix through all phase models."""
    ...
    for case in cases.itertuples(index=False):
        ...
        cruise = cruise_model.optimum(float(case.weight_lb), loadout.model_drag_index)
        climb = climb_model.profile(
            float(case.weight_lb),
